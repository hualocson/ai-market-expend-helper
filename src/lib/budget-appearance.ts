...
export const BUDGET_COLOR_OPTIONS = [
  {
    id: "lime",
    label: "Lime",
    chipClassName: "bg-primary/14 text-primary",
    swatchClassName: "bg-primary",
  },
  {
    id: "sky",
    label: "Sky",
    chipClassName: "bg-sky-400/14 text-sky-300",
    swatchClassName: "bg-sky-400",
  },
  {
    id: "violet",
    label: "Violet",
    chipClassName: "bg-violet-400/14 text-violet-300",
    swatchClassName: "bg-violet-400",
  },
  {
    id: "rose",
    label: "Rose",
    chipClassName: "bg-rose-400/14 text-rose-300",
    swatchClassName: "bg-rose-400",
  },
  {
    id: "amber",
    label: "Amber",
    chipClassName: "bg-amber-400/14 text-amber-300",
    swatchClassName: "bg-amber-400",
  },
  {
    id: "emerald",
    label: "Emerald",
    chipClassName: "bg-emerald-400/14 text-emerald-300",
    swatchClassName: "bg-emerald-400",
  },
  {
    id: "cyan",
    label: "Cyan",
    chipClassName: "bg-cyan-400/14 text-cyan-300",
    swatchClassName: "bg-cyan-400",
  },
  {
    id: "fuchsia",
    label: "Fuchsia",
    chipClassName: "bg-fuchsia-400/14 text-fuchsia-300",
    swatchClassName: "bg-fuchsia-400",
  },
  {
    id: "orange",
    label: "Orange",
    chipClassName: "bg-orange-400/14 text-orange-300",
    swatchClassName: "bg-orange-400",
  },
  {
    id: "teal",
    label: "Teal",
    chipClassName: "bg-teal-400/14 text-teal-300",
    swatchClassName: "bg-teal-400",
  },
  {
    id: "indigo",
    label: "Indigo",
    chipClassName: "bg-indigo-400/14 text-indigo-300",
    swatchClassName: "bg-indigo-400",
  },
  {
    id: "slate",
    label: "Slate",
    chipClassName: "bg-slate-400/14 text-slate-200",
